...
void NormalCourse::runNormalCourse()
{
  ...
  std::array<NormalCourseProperty, size> normalCourseProperty
       ...
       */
      = { {
          { 600, baseSpeed, { 0.1, 0.0, 0.1 }, { 0.9, 0.01, 0.06 } },         // 第1区間
          { 800, baseSpeed - 50, { 1.5, 0.0, 0.1 }, { 1.1, 0.01, 0.07 } },    // 第2区間
          { 1200, baseSpeed - 180, { 0.3, 0.0, 0.1 }, { 1.1, 0.01, 0.05 } },  // 第3区間
          { 2300, baseSpeed, { 0.1, 0.0, 0.1 }, { 1.2, 0.01, 0.05 } },        // 第4区間
          { 1000, baseSpeed + 100, { 0.1, 0.0, 0.1 }, { 0.9, 0.01, 0.04 } },  // 第5区間
          { 1300, baseSpeed + 100, { 2.0, 0.0, 0.1 }, { 1.0, 0.01, 0.05 } },  // 第6区間
          { 2500, baseSpeed + 50, { 0.1, 0.0, 0.1 }, { 1.1, 0.01, 0.05 } },   // 第7区間
      } };
